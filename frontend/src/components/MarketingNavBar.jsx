...
const ThreeBackground = React.memo(({
    ...
    useEffect(() => {
        ...
        const handleResize = () => {
            if (mountRef.current && rendererRef.current && materialRef.current) {
    ...
    }, [hueShift, noiseIntensity, scanlineIntensity, scanlineFrequency, warpAmount, speed]);
...
const MarketingNavBar = () => {
  ...
  // Style constants (identical to MainNavBar)
